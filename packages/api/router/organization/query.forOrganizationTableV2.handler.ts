...
import { type TForOrganizationTableV2Schema } from './query.forOrganizationTableV2.schema'
...
const buildWhere = (input: TForOrganizationTableV2Schema): Prisma.OrganizationWhereInput => {
...
const buildOrderBy = (
	sorting: TForOrganizationTableV2Schema['sorting']
...
const searchIds = async (
	input: TForOrganizationTableV2Schema & { search: string }
...
const forOrganizationTableV2 = async ({ input }: TRPCHandlerParams<TForOrganizationTableV2Schema>) => {
...
export default forOrganizationTableV2
