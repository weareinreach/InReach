...
export class Convert {
	public static toReviewsJSONCollection(json: string): ReviewsJSONCollection[] {
		return cast(JSON.parse(json), a(r('ReviewsJSONCollection')))
	}

	public static reviewsJSONCollectionToJson(value: ReviewsJSONCollection[]): string {
		return JSON.stringify(uncast(value, a(r('ReviewsJSONCollection'))), null, 2)
	}
}
...
const typeMap: any = {
	ReviewsJSONCollection: o(
		[
			{ json: '_id', js: '_id', typ: r('ID') },
			{ json: 'negativeReasons', js: 'negativeReasons', typ: a('') },
			...
			{ json: 'hasAccount', js: 'hasAccount', typ: u(undefined, true) },
			{ json: 'hasLeftFeedbackBefore', js: 'hasLeftFeedbackBefore', typ: u(undefined, true) },
