...
const _SocialMediaDrawer = forwardRef<HTMLButtonElement, SocialMediaDrawerProps>(({ id, ...props }, ref) => {
	const { data, isFetching } = api.orgSocialMedia.forEditDrawer.useQuery({ id })
					...
					>
						...
						<Drawer.Body>
							...
							<Stack spacing={24} align='center'>
								<Title order={2}>Edit Social Media</Title>
