		...
		const newAlert = await prisma.locationAlert.create({
			data: {
				...
				text: generateNestedFreeText({
					...
					itemId: alertId,
					text: 'This <Link href="https://www.erininthemorning.com/p/anti-trans-legislative-risk-assessment-2a4">anti-trans legislative risk map</Link> shows the 2-year risk for anti-trans laws in all 50 states and D.C.',
				}),
