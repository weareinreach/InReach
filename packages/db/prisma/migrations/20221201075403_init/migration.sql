...
-- CreateEnum
CREATE TYPE "SourceType" AS ENUM ('EXTERNAL', 'ORGANIZATION', 'USER', 'SYSTEM');
...
-- CreateIndex
CREATE INDEX "User_associatedOrgId_idx" ON "User"("associatedOrgId" ASC);
...
-- CreateIndex
CREATE UNIQUE INDEX "UserType_keyId_key" ON "UserType"("keyId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "UserTitle_title_key" ON "UserTitle"("title");

-- CreateIndex
CREATE UNIQUE INDEX "UserTitle_keyId_key" ON "UserTitle"("keyId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "UserEthnicity_ethnicity_key" ON "UserEthnicity"("ethnicity");

-- CreateIndex
CREATE UNIQUE INDEX "UserEthnicity_keyId_key" ON "UserEthnicity"("keyId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "UserImmigration_status_key" ON "UserImmigration"("status");

-- CreateIndex
CREATE UNIQUE INDEX "UserImmigration_keyId_key" ON "UserImmigration"("keyId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "UserSOGIdentity_identifyAs_key" ON "UserSOGIdentity"("identifyAs");

-- CreateIndex
CREATE UNIQUE INDEX "UserSOGIdentity_keyId_key" ON "UserSOGIdentity"("keyId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "UserCommunity_community_key" ON "UserCommunity"("community");

-- CreateIndex
CREATE UNIQUE INDEX "UserCommunity_keyId_key" ON "UserCommunity"("keyId" ASC);
...
-- CreateIndex
CREATE UNIQUE INDEX "OrgDescription_keyId_key" ON "OrgDescription"("keyId" ASC);
...
-- CreateIndex
CREATE INDEX "OrgEmail_orgId_idx" ON "OrgEmail"("orgId" ASC);

-- CreateIndex
CREATE INDEX "OrgEmail_orgLocationId_idx" ON "OrgEmail"("orgLocationId" ASC);

-- CreateIndex
CREATE INDEX "OrgEmail_orgId_orgLocationId_idx" ON "OrgEmail"("orgId", "orgLocationId");
...
-- CreateIndex
CREATE INDEX "OrgPhone_organizationId_orgLocationId_idx" ON "OrgPhone"("organizationId" ASC, "orgLocationId" ASC);

-- CreateIndex
CREATE INDEX "OrgPhone_organizationId_idx" ON "OrgPhone"("organizationId" ASC);

-- CreateIndex
CREATE INDEX "OrgPhone_orgLocationId_idx" ON "OrgPhone"("orgLocationId" ASC);

-- CreateIndex
CREATE INDEX "OrgSocialMedia_organizationId_orgLocationId_idx" ON "OrgSocialMedia"("organizationId" ASC, "orgLocationId" ASC);

-- CreateIndex
CREATE INDEX "OrgSocialMedia_organizationId_idx" ON "OrgSocialMedia"("organizationId" ASC);

-- CreateIndex
CREATE INDEX "OrgSocialMedia_orgLocationId_idx" ON "OrgSocialMedia"("orgLocationId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "OrgLocation_orgId_key" ON "OrgLocation"("orgId" ASC);
...
-- CreateIndex
CREATE INDEX "OrgPhoto_orgId_orgLocationId_idx" ON "OrgPhoto"("orgId" ASC, "orgLocationId" ASC);

-- CreateIndex
CREATE INDEX "OrgPhoto_orgId_idx" ON "OrgPhoto"("orgId" ASC);

-- CreateIndex
CREATE INDEX "OrgPhoto_orgLocationId_idx" ON "OrgPhoto"("orgLocationId" ASC);

-- CreateIndex
CREATE INDEX "OrgHours_orgLocId_orgServiceId_idx" ON "OrgHours"("orgLocId" ASC, "orgServiceId" ASC);

-- CreateIndex
CREATE INDEX "OrgHours_orgLocId_idx" ON "OrgHours"("orgLocId" ASC);

-- CreateIndex
CREATE INDEX "OrgHours_orgServiceId_idx" ON "OrgHours"("orgServiceId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "OrgService_accessKeyId_key" ON "OrgService"("accessKeyId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "OrgService_descKeyId_key" ON "OrgService"("descKeyId" ASC);
...
-- CreateIndex
CREATE UNIQUE INDEX "ServiceCategory_keyId_key" ON "ServiceCategory"("keyId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "ServiceTag_keyId_key" ON "ServiceTag"("keyId" ASC);
...
-- CreateIndex
CREATE UNIQUE INDEX "PhoneType_keyId_key" ON "PhoneType"("keyId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "SocialMediaService_name_key" ON "SocialMediaService"("name");

-- CreateIndex
CREATE UNIQUE INDEX "SocialMediaService_keyId_key" ON "SocialMediaService"("keyId" ASC);
...
-- CreateIndex
CREATE UNIQUE INDEX "Country_keyId_key" ON "Country"("keyId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "GovDist_slug_key" ON "GovDist"("slug");

-- CreateIndex
CREATE UNIQUE INDEX "GovDist_keyId_key" ON "GovDist"("keyId" ASC);

-- CreateIndex
CREATE INDEX "GovDist_countryId_idx" ON "GovDist"("countryId");

-- CreateIndex
CREATE INDEX "GovDist_countryId_parentId_idx" ON "GovDist"("countryId", "parentId");

-- CreateIndex
CREATE UNIQUE INDEX "GovDistType_name_key" ON "GovDistType"("name");

-- CreateIndex
CREATE UNIQUE INDEX "GovDistType_keyId_key" ON "GovDistType"("keyId" ASC);
...
-- CreateIndex
CREATE UNIQUE INDEX "Navigation_keyId_key" ON "Navigation"("keyId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "Navigation_display_href_key" ON "Navigation"("display", "href");

-- CreateIndex
CREATE UNIQUE INDEX "FooterLink_keyId_key" ON "FooterLink"("keyId" ASC);
