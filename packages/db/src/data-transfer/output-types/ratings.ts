...
export class Convert {
	public static toRatingsJSONCollection(json: string): RatingsJSONCollection[] {
		return cast(JSON.parse(json), a(r('RatingsJSONCollection')))
	}

	public static ratingsJSONCollectionToJson(value: RatingsJSONCollection[]): string {
		return JSON.stringify(uncast(value, a(r('RatingsJSONCollection'))), null, 2)
	}
}
