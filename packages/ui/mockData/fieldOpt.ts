...
export const attributesByCategory = [
	...
	},
	{
		...
		categoryName: 'service-provider-options',
		categoryDisplay: 'Service Provider Options',
		attributeId: 'attr_01GW2HHFVSVSBFQ700RMJ19ABC',
		attributeName: 'community-organization',
		attributeKey: 'userserviceprovider.community-organization',
		attributeNs: 'attribute',
		requireText: false,
		requireLanguage: false,
		requireGeo: false,
	...
	},
	{
		...
		categoryName: 'service-provider-options',
		categoryDisplay: 'Service Provider Options',
		attributeId: 'attr_01GW2HHFVSE2074QZJ4SKEWXYZ',
		attributeName: 'serv-other',
		attributeKey: 'userserviceprovider.serv-other',
		attributeNs: 'attribute',
		requireText: false,
		requireLanguage: false,
		requireGeo: false,
