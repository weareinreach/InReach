...
export class Convert {
	public static toSuggestionsJSONCollection(json: string): SuggestionsJSONCollection[] {
		return cast(JSON.parse(json), a(r('SuggestionsJSONCollection')))
	}

	public static suggestionsJSONCollectionToJson(value: SuggestionsJSONCollection[]): string {
		return JSON.stringify(uncast(value, a(r('SuggestionsJSONCollection'))), null, 2)
	}
}
