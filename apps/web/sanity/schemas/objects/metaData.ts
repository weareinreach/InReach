 ...
 */
const falseIfBlog = (context: ConditionalPropertyCallbackContext) => context.document?._type !== 'post'
const trueIfBlog = (context: ConditionalPropertyCallbackContext) => context.document?._type === 'post'
