...
export class Convert {
	public static toCommentsJSONCollection(json: string): CommentsJSONCollection[] {
		return cast(JSON.parse(json), a(r('CommentsJSONCollection')))
	}

	public static commentsJSONCollectionToJson(value: CommentsJSONCollection[]): string {
		return JSON.stringify(uncast(value, a(r('CommentsJSONCollection'))), null, 2)
	}
}
...
const typeMap: any = {
	...
	Comment: o(
		[
			...
			{ json: 'is_deleted', js: 'is_deleted', typ: u(undefined, true) },
			{ json: 'isUserApproved', js: 'isUserApproved', typ: u(undefined, true) },
			{ json: 'isDeleted', js: 'isDeleted', typ: u(undefined, true) },
			{ json: 'userLocation', js: 'userLocation', typ: u(undefined, '') },
		],
		false
	),
	AtedAt: o([{ json: '$date', js: '$date', typ: Date }], false),
	Source: ['catalog', 'reviewer'],
}
