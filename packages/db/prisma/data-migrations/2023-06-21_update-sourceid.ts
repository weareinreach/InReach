...
const jobDef: JobDef = {
	jobId: '2023-06-21_update-sourceid',
	title: 'Update source id for migration',
	createdBy: 'Joe Karow',
}
/**
...
export const job20230621a = {
	...
	task: async (_ctx, task) => {
		...
		const update = await prisma.source.update({
			where: { id: 'clfii2q0e00009kjupxn7403t' },
			data: { id: 'srce_01H3FR96DFKRAM07AZ8T8MXHE5' },
		})
		task.output = `${isSuccess(update)} Source record updated`
